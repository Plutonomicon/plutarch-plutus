...
spec = do
  describe "trace" . pgoldenSpec $ do
    "ptrace" @\ do
      "one"
        @| ptrace "foo" (pcon PUnit) @-> \p ->
          ptraces p ["foo"]
      "two"
        @| ptrace "foo" (ptrace "bar" (pcon PUnit)) @-> \p ->
          ptraces p ["foo", "bar"]
    "ptraceShowId" @\ do
    ...
    "ptraceIfTrue" @\ do
      "true"
        @| ptraceIfTrue "foo" (pcon PTrue) @-> \p ->
          p `ptraces` ["foo"]
      "false"
        @| ptraceIfTrue "foo" (pcon PFalse) @-> \p ->
          p `ptraces` []
    "ptraceIfFalse" @\ do
      "true"
        @| ptraceIfFalse "foo" (pcon PTrue) @-> \p ->
          p `ptraces` []
      "false"
        @| ptraceIfFalse "foo" (pcon PFalse) @-> \p ->
          p `ptraces` ["foo"]
    "chained" @\ do
      "false.true.false"
