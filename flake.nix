{
  ...
  outputs = inputs@{ self, nixpkgs, iohk-nix, haskell-nix, hercules-ci-effects, ... }:
    let
      ...
      applyPlutarchDep = pkgs: o: o // {
        modules = haskellModules ++ o.modules;
        cabalProjectLocal =
    ...
    in
    {
      inherit tools applyPlutarchDep;
