...
import Plutarch.Internal.Term (PDelayed, S, Term, pdelay, pforce, phoistAcyclic, plam', punsafeCoerce, (#), (:-->))
...
newtype DeriveAsScottStruct (a :: S -> Type) s = DeriveAsScottStruct {unDeriveAsScottStruct :: a s}
...
newtype DeriveAsScottRec (a :: S -> Type) s = DeriveAsScottRec {unDeriveAsScottRec :: a s}
