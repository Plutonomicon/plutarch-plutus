...
tests =
  testGroup
    ...
    , testGroup
        ...
        , testCase "even" $ (printTerm $ evenOdd # field even) @?= "(program 1.0.0 ((\\i0 -> (\\i0 -> (\\i0 -> i2 (\\i0 -> i2 i2 i1)) (\\i0 -> i2 (\\i0 -> i2 i2 i1))) (\\i0 -> \\i0 -> i1 (\\i0 -> force (force ifThenElse (equalsInteger i1 0) (delay True) (delay (i3 (\\i0 -> \\i0 -> i1) (subtractInteger i1 1))))) (\\i0 -> force (force ifThenElse (equalsInteger i1 0) (delay False) (delay (i3 i4 (subtractInteger i1 1)))))) i1) (\\i0 -> \\i0 -> i2)))"
...
result_fieldFromDataTerm'simpleRecord =
#ifdef Development
  "(program 1.0.0 (\\i0 -> unIData ((\\i0 -> force (force ifThenElse (equalsInteger (force (force fstPair) i1) 0) (delay (force headList (force tailList (force (force sndPair) i1)))) (delay (force (force trace \"verifySoleConstructor failed\" (delay error)))))) (unConstrData i1))))"
#else
...
result_fieldFromDataTerm'flatNested =
#ifdef Development
  "(program 1.0.0 (\\i0 -> unIData ((\\i0 -> force (force ifThenElse (equalsInteger (force (force fstPair) i1) 0) (delay (force headList (force tailList (force tailList (force tailList (force tailList (force tailList (force tailList (force (force sndPair) i1))))))))) (delay (force (force trace \"verifySoleConstructor failed\" (delay error)))))) (unConstrData i1))))"
#else
  "(program 1.0.0 (\\i0 -> unIData ((\\i0 -> force (force ifThenElse (equalsInteger (force (force fstPair) i1) 0) (delay (force headList (force tailList (force tailList (force tailList (force tailList (force tailList (force tailList (force (force sndPair) i1))))))))) (delay error))) (unConstrData i1))))"
#endif

result_fieldFromDataTerm'shallowNested :: String
result_fieldFromDataTerm'shallowNested =
#ifdef Development
  "(program 1.0.0 ((\\i0 -> \\i0 -> (\\i0 -> (\\i0 -> force (force ifThenElse (equalsInteger (force (force fstPair) i1) 0) (delay (\\i0 -> i1 ((\\i0 -> equalsInteger (force (force fstPair) (unConstrData i1)) 1) (force headList (force (force sndPair) i2))) (unIData (force headList (force tailList (force (force sndPair) i2)))) (decodeUtf8 (unBData (force headList (force tailList (force tailList (force (force sndPair) i2)))))))) (delay (force (force trace i4 (delay error)))))) (unConstrData i1)) ((\\i0 -> force (force ifThenElse (equalsInteger (force (force fstPair) i1) 0) (delay (force headList (force tailList (force tailList (force tailList (force (force sndPair) i1)))))) (delay (force (force trace i3 (delay error)))))) (unConstrData i1)) (\\i0 -> \\i0 -> \\i0 -> i2)) \"verifySoleConstructor failed\"))"
#else
  "(program 1.0.0 (\\i0 -> (\\i0 -> (\\i0 -> force (force ifThenElse (equalsInteger (force (force fstPair) i1) 0) (delay (\\i0 -> i1 ((\\i0 -> equalsInteger (force (force fstPair) (unConstrData i1)) 1) (force headList (force (force sndPair) i2))) (unIData (force headList (force tailList (force (force sndPair) i2)))) (decodeUtf8 (unBData (force headList (force tailList (force tailList (force (force sndPair) i2)))))))) (delay error))) (unConstrData i1)) ((\\i0 -> force (force ifThenElse (equalsInteger (force (force fstPair) i1) 0) (delay (force headList (force tailList (force tailList (force tailList (force (force sndPair) i1)))))) (delay error))) (unConstrData i1)) (\\i0 -> \\i0 -> \\i0 -> i2)))"
#endif

result_fieldFromDataValue'shallowNested :: String
result_fieldFromDataValue'shallowNested =
#ifdef Development
  "(program 1.0.0 (\\i0 -> (\\i0 -> force (force ifThenElse (equalsInteger (force (force fstPair) i1) 0) (delay (\\i0 -> i1 ((\\i0 -> equalsInteger (force (force fstPair) (unConstrData i1)) 1) (force headList (force (force sndPair) i2))) (unIData (force headList (force tailList (force (force sndPair) i2)))) (decodeUtf8 (unBData (force headList (force tailList (force tailList (force (force sndPair) i2)))))))) (delay (force (force trace \"verifySoleConstructor failed\" (delay error)))))) (unConstrData i1) (\\i0 -> \\i0 -> \\i0 -> i2)))"
#else
