  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "record-dot-preprocessor".revision = (((hackage."record-dot-preprocessor")."0.2.14").revisions).default;
  ...
  extras = hackage:
    {
      packages = {
        ...
        shrinker = ./.plan.nix/shrinker.nix;
    ...
    ({ lib, ... }:
      {
        packages = {
          ...
          "shrinker".components.library.planned = lib.mkOverride 900 true;
