  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "brittany".revision = (((hackage."brittany")."0.14.0.2").revisions).default;
        "brittany".flags.pedantic = false;
        ...
        "ghc-lib-parser-ex".revision = (((hackage."ghc-lib-parser-ex")."9.2.0.1").revisions).default;
        ...
        "ghc-lib".revision = (((hackage."ghc-lib")."9.2.1.20220109").revisions).default;
